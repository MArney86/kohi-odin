...
renderer_initialize_func :: proc(^renderer_backend, string, ^platform_state) -> b8
renderer_shutdown_func :: proc(^renderer_backend)
renderer_resized_func :: proc(^renderer_backend, u16, u16)
renderer_begin_frame_func :: proc(^renderer_backend, f32) -> b8
renderer_end_frame_func :: proc(^renderer_backend, f32) -> b8
